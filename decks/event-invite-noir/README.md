# event-invite-noir — event invitation (noir-lime)
...
The same invitation on the `poster-swiss` art pack is `event-invite`; content,
fields and mechanics of the two decks match.
...
To build on this deck, copy `decks/event-invite-noir/` into your working folder and add
